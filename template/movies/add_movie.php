                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" name="movie_name" class="form-control" id="movie_name" value="<?php echo (!empty($value->movie_name)) ? $value->movie_name : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="movie_imdb_id" class="form-label">Movie IMDB Id</label>
                            <input type="text" name="movie_imdb_id" class="form-control" id="movie_imdb_id" value="<?php echo (!empty($value->movie_imdb_id)) ? $value->movie_imdb_id : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="movie_runtime" class="form-label">Movie Runtime</label>
                            <input type="text" name="movie_runtime" class="form-control" id="movie_runtime" value="<?php echo (!empty($value->movie_runtime)) ? $value->movie_runtime : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="movie_release_date" class="form-label">Movie Release Date</label>
                            <input type="text" name="movie_release_date" class="form-control" id="movie_release_date" value="<?php echo (!empty($value->movie_release_date)) ? $value->movie_release_date : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="movie_description" class="form-label">Movie Description</label>
                            <textarea type="text" name="movie_description" class="form-control" id="movie_description"><?php echo (!empty($value->movie_description)) ? $value->movie_description : ''; ?></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="movie_cast" class="form-control" id="movie_cast" value="<?php echo $value->movie_cast ?>">
                        </div>
                        <div class="mb-3">
                            <label for="movie_crew" class="form-label">Movie Crew</label>
                            <input type="text" name="movie_crew" class="form-control" id="movie_crew" value="<?php echo $value->movie_crew; ?>">
                        </div>
                        <?php
                        if ($id) {
                        ?>
