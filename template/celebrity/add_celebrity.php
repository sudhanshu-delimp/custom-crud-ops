                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="celebrity_birth_date" class="form-control" id="celebrity_birth_date" value="<?php echo (!empty($value->celebrity_birth_date)) ? $value->celebrity_birth_date : ''; ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <!-- <input type="text" name="celebrity_image_galleries" class="form-control" id="celebrity_image_galleries" value="<?php // echo (!empty($value))?$value->celebrity_imdb_id:''; 
                                                                                                               ?>"> -->
                            </div>
                        </div>
                       <div class="row">
