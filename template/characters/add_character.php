                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" name="character_name" class="form-control" id="character_name" value="<?php echo (!empty($value->character_name)) ? $value->character_name : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="character_title_choice" class="form-label">Character Title Choice</label>
                            <input type="text" name="character_title_choice" class="form-control" id="character_title_choice" value="<?php echo (!empty($value->character_title_choice)) ? $value->character_title_choice : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="character_movie" class="form-label">Character Movie</label>
                            <select name="character_movie" class="form-select" id="character_movie" value="<?php echo (!empty($value->character_movie)) ? $value->character_movie : ''; ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="character_show" class="form-select" id="character_show" value="<?php echo (!empty($value->character_show)) ? $value->character_show : ''; ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="character_celebrity" class="form-select" id="character_celebrity" value="<?php echo (!empty($value->character_celebrity)) ? $value->character_celebrity : ''; ?>">
                                <option value="1">Xyz</option>
                                <option value="2">Abc</option>
                                <option value="3">Pqr</option>
                                <option value="4">Efg</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="character_character" class="form-select" id="character_character" value="<?php echo (!empty($value->character_character)) ? $value->character_character : ''; ?>">
                                <option value="1">Xyz</option>
                                <option value="2">Abc</option>
                                <option value="3">Pqr</option>
                                <option value="4">Efg</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="character_videos" class="form-control" id="character_videos" value="<?php echo (!empty($value->character_videos)) ? $value->character_videos : '' ?>">
                        </div>
                        <div class="mb-3">
                            <label for="character_embeds" class="form-label">Character Embeds</label>
                            <input type="text" name="character_embeds" class="form-control" id="character_embeds" value="<?php echo (!empty($value->character_embeds)) ? $value->character_embeds : '' ?>">
                        </div>
                        <div class="mb-3">
                            <label for="character_external_media" class="form-label">Character External Media</label>
                            <input type="text" name="character_external_media" class="form-control" id="character_external_media" value="<?php echo (!empty($value->character_external_media)) ? $value->character_external_media : '' ?>">
                        </div>
                        <?php
                        if ($id) {
                        ?>
